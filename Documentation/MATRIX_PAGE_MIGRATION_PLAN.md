...
- The DB editor internals are still rendered with legacy-heavy inline row markup and need another pass to be fully normalized.
...
- Active port detail internals are still generated by legacy-oriented JS markup and need a second pass to be fully normalized.
