...
PLC_AUTO_HOME_WAYPOINT = {'x': 6.8, 'y': -99.1, 'z': 94.1}  # re-measured 2026-09-09, operator-set to avoid a physical collision
...
# PoE alias for /api/vision/annotated-result removed — USB / color-voting
# pipeline reactivated owns this URL again. The PoE-native annotated stream
# is still available at /api/poe-vision/annotated.
...
def read_main_db_tags():
    ...
    try:
        ...
        tags = {
            ...
            'inspection_result': int(cache.get('inspection_result', 0)),
            'inspection_done': bool(cache.get('inspection_done', False)),
...
def read_robot_db_tags():
    ...
    try:
        ...
        tags = {
            ...
            'execute_move': bool(cache.get('db125_execute_move', False)),
