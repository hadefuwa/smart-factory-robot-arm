...
// Default baud rate for the ST3215 bus used on this setup.
...
class ServoController {
    ...
    async readData(address, length) {
        ...
        const readPromise = new Promise((resolve, reject) => {
            ...
            // Reads on the SC-B1 bridge need a little more breathing room than direct UART.
    ...
    async writeData(address, data) {
        ...
        // These servos on the SC-B1 bridge do not reliably send write acknowledgements.
        // Treat writes as fire-and-forget and leave the response path reserved for reads/pings.
        this.pendingResponse = null;
        if (this.responseTimeout) {
            clearTimeout(this.responseTimeout);
            this.responseTimeout = null;
